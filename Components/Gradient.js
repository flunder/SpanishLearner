...
export const GradientPresets = {
    purple:  { color1: '#A893FF', color2: '#7660FE', opacity1: 1, opacity2: 1 },
    warm:    { color1: '#FFAD7F', color2: '#FB68A6', opacity1: 1, opacity2: 1 }
}
...
class Gradient extends React.PureComponent {
  ...
  directionProps = {
    ...
    reverse: {
      horizontal: { x2: '0%', y2: '50%', x1: '100%', y1: '50%', },
      vertical:   { x2: '50%', y2: '0%', x1: '50%', y1: '100%', },
    },
  };
